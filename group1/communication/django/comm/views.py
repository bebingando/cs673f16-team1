...
from comm.serializers import UserSerializer, RoomSerializer, MessageSerializer, MessageDataSerializer, \
    UserRoomSerializer, UserRoomDataSerializer
import random
...
class MessageDataViewSet(viewsets.ReadOnlyModelViewSet):
    # This viewset will show all of the messages in the message model and all of the data associated with those
    # messages.  The data from the models User and Room will be displayed.
    queryset = Message.objects.all().order_by('time')
